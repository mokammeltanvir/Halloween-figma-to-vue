<script setup>
  import category1 from "../assets/img/category/category1-img.webp"
  import category2 from "../assets/img/category/category2-img.webp"
  import category3 from "../assets/img/category/category3-img.webp"
  ...
  <section id="about" class="grid grid-flow-col grid-cols-1 md:grid-cols-2 md:gap-10 items-center">
    ...
    <div class="text-center flex flex-col items-center">
      ...
      <div class="flex items-center gap-5">
        ...
        <img src="../assets/img/head2-img.png" class="w-9 md:w-12" alt="head2">
      </div>
