  ...
  <footer>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-28">
      <div>
        ...
        <div class="flex justify-end md:justify-start -mt-7 md:mt-3">
          <img class="w-12 md:-translate-x-10 scale-x-[-1] md:scale-100" src="../assets/img/footer2-img.webp" alt="">
        </div>
      </div>
    ...
    <div class="grid place-items-center my-20 w-full ">
      <div class="flex items-center gap-10">
        <a href="#" class="bg-secondary hover:bg-orange-600 h-12 w-12 grid place-items-center rounded-md">
